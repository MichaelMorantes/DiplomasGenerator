...
AND padps_plan_estudio.fNUGetCICLO_PLANESTUDIO_ID(B.PLAN_ESTUDIO_ID)=1
AND B.PENSUM_X_PLESTUDIO_ID IS NOT NULL
AND A.ESTADO_ESTUDIANTE_ID NOT IN('GRA', 'AGR')
AND A.PLAN_ESTUDIO_ID NOT IN('10','53','70','83','54','11','12','14','79','80','65')
AND DECODE(B.PENSUM_X_PLESTUDIO_ID,NULL,99,RC_MATERIAS_PENDIENTES(A.ESTUDIANTE_ID,B.PENSUM_X_PLESTUDIO_ID)) <='5'